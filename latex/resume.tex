...
\begin{flushleft}
	...
	\begin{itemize}
		...
		\item Attempt to do basic trading algorithms with more than 100,000 data points crawled by Python Scrapy \item Build with Python, InfluxDB, and Google Cloud Platform Virtual Machines
	\end{itemize}	
	...
	%== Tomcat 9 Free Port ==
	\textbf{Apache Tomcat 9 Free Port:}  Spring 2019
	\vspace{-\topsep}
	\begin{itemize}
		\setlength{\parskip}{0pt}
		\setlength{\itemsep}{0pt plus 1pt}
...
\begin{flushleft}
	...
	\vspace{-\topsep}
		\begin{itemize}
			...
			\item In training progress to be a GitHub Campus Expert with training from GitHub to support and grow the developer community on campus
		\end{itemize}
\centering{\noindent\makebox{\rule{8cm}{1.5pt}}}
\end{flushleft} 
%====== Skills ======
