...
\begin{flushleft}
	...
	\begin{itemize}
		...
		\item Developing a module capturing and resolving date/time into structured data for the first Vietnamese Question-Answering System at Zalo AI
		\item Build an algorithm(rule, regular expressions, and lunar calculator) to analyze date/time questions related to Vietnamese Lunar Calendar in Haskell
		\item The module has a potential to be deploy on the \href{https://oa.zalo.me/home}{Zalo App} for more than 100 millions Vietnamese users
	\end{itemize}
\vspace{-\topsep}
\centering{\noindent\makebox{\rule{8cm}{1.5pt}}}
\end{flushleft} 
...
\begin{flushleft}
	...
	\begin{itemize}
		...
		\item Main Developer and Maintainer for the HackCWRU-2020's official website, built with React: \href{https://hackcwru.github.io/HackCWRU2020-Website/}{coming soon}
	\end{itemize}
...
\begin{flushleft}
	\textbf{Programming Language:} Java, Haskell, R \\ 
	\doublespacing
	\textbf{Software and Frameworks:} React.js, Stack(Haskell), MVC, Spring Framework, JSP \\
\vspace{-\topsep}
\centering{\noindent\makebox{\rule{8cm}{1.5pt}}}
\end{flushleft}
