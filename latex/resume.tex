...
\begin{flushleft}
	...
	\begin{itemize}
		...
		\item Developing a module capturing and resolving date/time text into structured data for the first Vietnamese Question-Answering System at Zalo AI 
		\item Utilize regular expression to build an algorithm and rule resolving time data for Vietnamese Lunar Calendar questions 
