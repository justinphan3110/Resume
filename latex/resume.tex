...
\begin{flushleft}
	...
	\textbf{Relevant Courses:} Introduction to programming in Java, Data Structures, Discrete Math   \\
...
\begin{flushleft}
	...
	\begin{itemize}
		...
		\item Initiated and led the development of an agnostic NER module capturing and resolving date/time text into structured data for Kiki, the first Vietnamese virtual personal assistant
...
\begin{flushleft}
	...
	\doublespacing
	\textbf{Software and Frameworks:} Haskell Tool Stack, Spring, React.js, Elastic Search, Kibana, InfluxDB \\
\vspace{-\topsep}
\centering{\noindent\makebox{\rule{8cm}{1.5pt}}}
\end{flushleft}
...
\begin{flushleft}
  ...
  \begin{itemize}
  	...
  	\item Attempt to do some basic trading algorithms with more than 100,000 data points crawled by Python Scrapy \item Build with Python and InfluxDB
  \end{itemize}	
 ...
 \begin{itemize}
 	...
 	\item Built with Java, R, and Spring
 \end{itemize}
  ...
  \begin{itemize}
  	...
  	\item Built with Java, and Spring
  \end{itemize}
\end{flushleft}
\end{document}
